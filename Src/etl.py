...
def process_song_file(cur, filepath):
    """
    - Processes and loads data from one song file to song and artist tables
    - Accepts cursor and file path of song
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    - Processes and loads data from one log file to time, songplay and user tables
    - Accepts cursor and file path of log
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    """
    - Scans file path recursively to locate all JSON files
    - Processes and loads data recursively from root directory location
    Args:
        cur: psycopg2 cursor
